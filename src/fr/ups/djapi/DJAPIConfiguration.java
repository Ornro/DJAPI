...
/**
 * Configuration Singleton used to set up a connection to the database specified in the
 ...
 */
public final class DJAPIConfiguration { /* Singleton pattern for configuration file. */
